python train_HCAN.py --data_dir=../dream --xlnet_model=xlnet-large-cased --output_dir=xlnet_dream --task=dream --max_no_sent=15 --max_sent_len=15 --d_lstm=512 --lstm_layers=2 --do_train --do_eval --train_batch_size=32 --eval_batch_size=2 --learning_rate=2e-5 --num_train_epochs=3 --warmup_steps=120 --weight_decay=0.0 --adam_epsilon=1e-6 --gradient_accumulation_steps=16 
